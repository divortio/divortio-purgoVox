...
import { OUTPUT_FORMAT, OUTPUT_QUALITY } from '../../../constants/config.js';

/**
 * @typedef {import('../../../js/ffmpeg-pipeline.js').FFmpeg} FFmpeg
...
export async function masterEncode(ffmpeg, normalizedFile, rmsLevel, options, logStore) {
    ...
    try {
        ...
        // --- Cleanup ---
        // Ensure the temporary normalized file from Pass 2 is always deleted.
        try {
